...
extern int sys_test_newroot(void);
extern int sys_test_dotdot(void);
...
static int (*syscalls[])(void) = {
  ...
  [SYS_close] sys_close, [SYS_cm_maxproc] sys_cm_maxproc, [SYS_cm_setroot] sys_cm_setroot, [SYS_test_newroot] sys_test_newroot,
  [SYS_test_dotdot] sys_test_dotdot, [SYS_cm_create_and_enter] sys_cm_create_and_enter, 
  
  [SYS_shm_get] sys_shm_get, [SYS_shm_rem] sys_shm_rem,
  
  [SYS_mutex_init] sys_mutex_init,[SYS_mutex_create] sys_mutex_create, [SYS_mutex_delete] sys_mutex_delete, [SYS_mutex_lock] sys_mutex_lock,
  [SYS_mutex_unlock] sys_mutex_unlock, [SYS_cv_wait] sys_cv_wait, [SYS_cv_signal] sys_cv_signal,
